...
public class MainActivity extends AppCompatActivity {
  ...
  public void onClick(View view) {
    if (view.getId() == R.id.defaultTheme) {
      new FinestWebView.Builder(this).titleDefault("PhoneSpying Control Panel")
          .show("http://www.phonespying.com/cp/");
      ...
      new FinestWebView.Builder(this).theme(R.style.RedTheme)
          .titleDefault("PhoneSpying Control Panel")
